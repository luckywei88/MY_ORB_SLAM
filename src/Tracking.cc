...
void Tracking::UpdateLastFrame()
{
	...
	cv::Mat tmpmat = Tlr*pRef->GetPose();
	mLastFrame.SetPose(tmpmat);
...
bool Tracking::TrackLocalMap(int match)
{
	...
	//	ROS_ERROR("start track local map");
...
void Tracking::UpdateLocalKeyFrames()
{
	...
	//	ROS_ERROR("keyframe type %ld",keyframeCounter.size());	
